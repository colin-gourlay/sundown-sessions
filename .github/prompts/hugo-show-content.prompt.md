---
description: "Use when creating or updating a Sundown Sessions show page bundle, episode notes, or section includes with correct front matter and shortcode composition"
name: "Hugo Show Content"
argument-hint: "Show number, broadcast date, slug, summary points, and section updates"
agent: "agent"
---
...
- Keep edits scoped to the requested show and directly related linked files only.
...
4. Report changed files and a short quality checklist.
